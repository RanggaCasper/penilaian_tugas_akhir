                    ...
                    <div>
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <span class="line-break w-50 text-end">{{ $list->student->proposal->title }}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span class="fw-semibold">Link Dokumen</span>
                                <a href="{{ $list->student->proposal->document }}" class="btn btn-sm btn-primary" target="_blank">Lihat Dokumen</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span class="fw-semibold">Link Dokumen Tambahan</span>
                                <a href="{{ $list->student->proposal->support_document }}" class="btn btn-sm btn-primary" target="_blank">Lihat Dokumen</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <li class="list-group-item">
                                <a href="{{ $list->assessments->contains('examiner_id', auth()->id()) ? route('lecturer.proposal.exam.generatePDF', $list->id) : '#' }}" 
