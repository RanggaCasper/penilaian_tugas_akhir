                        ...
                        <div class="mb-4 text-center mt-sm-5 text-white-50">
                            <div>
                                <a href="{{ route('home') }}" class="d-inline-block auth-logo">
                                    <img src="https://elearning.pnb.ac.id/img/logo-pnb.3aae610b.png" alt="" height="84">
                                </a>
                            </div>
                            <p class="mt-3 text-white fs-15 fw-medium">{{ config('app.name') }} - Politeknik Negeri Bali</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
