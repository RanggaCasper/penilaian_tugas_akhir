...
# API Endpoint  
api_url = 'http://127.0.0.1:8000/api/v1/proposal'  
...
def send_request():  
    ...
    try:  
        ...
        print(f"Response Code: {response.status_code}, Response: {response.json() if response.status_code == 200 else response.text}")  
